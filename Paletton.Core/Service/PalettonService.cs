// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PalettonService.cs" company="Vizioz Limited">
//   Copyright Vizioz Limited
// </copyright>
// <summary>
//   Defines the PalettonService type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------

namespace Paletton.Core.Service
{
    using System;
    ...
    using Paletton.Core.Enumerations;
    using Paletton.Core.Models;

    /// <summary>
    /// The palette service.
    /// </summary>
    internal class PalettonService
    {
        /// <summary>
        /// The get palette.
        /// </summary>
        ...
        /// </returns>
        internal PalettonPalette GetPalette(JToken jsonValue)
        {
            if (jsonValue == null)
            {
                return new PalettonPalette();
            }
        ...
        /// The <see cref="PalettonPalette"/>.
        /// </returns>
        private PalettonPalette GetPaletteFromXmlContent(string content)
        {
            ...
            try
            {
                var palette = new PalettonPalette();
                var colorSets = new List<PalettonColorSet>();
        ...
        /// </returns>
        private PalettonColorSet GetColorSet(XmlNode colorSetNode)
        {
            var colors = new List<PalettonColor>();
            ...
            return new PalettonColorSet { Id = setId, Title = setTitle, Colors = colors };
        }
        ...
        /// </returns>
        private PalettonColor GetColor(XmlNode colorNode)
        {
            if (colorNode?.Attributes != null)
            {
                ...
                return new PalettonColor { Id = id, Hex = rgb, Red = red, Green = green, Blue = blue };
            }
